...
<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        ...
        <div class="btn-toolbar mb-2 mb-md-0">
            ...
            <select class="form-select form-select-sm mx-1" style="width: 155px;" id="filter-prodi1">
        ...
        <table id="example" class="table table-sm table-bordered table-striped" style="min-width:6000px;">
            <thead>
                <tr class="text-center">
                    ...
                    <th>Prodi 1</th>
                    <th>Prodi 2</th>
                    <th>Prodi Yang dilulusi</th>
                    <th>Jenis Pilihan Kuliah</th>
                    <th>Daftar Ulang By</th>
                </tr>
            </thead>
            <tbody id="getforfilter">
                <?= $this->include('admin/tbody-daftar-ulang'); ?>
            </tbody>
        </table>
    </div>
