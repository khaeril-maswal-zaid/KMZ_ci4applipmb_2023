...
<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
    ...
    <form action="/admin/tentukanprodilulus" method="post">
        <?= csrf_field() ?>
        <div class="table-responsive">
            <table id="example" class="table table-sm table-bordered table-striped" style="width:100%;">
                ...
                <tbody id="getforfilter">
                    <?= $this->include('admin/tbody-set-prodi-lulus'); ?>
                </tbody>
            </table>
        </div>

        <button type="submit" name="proses-prodilulus" class="btn btn-primary btn-sm float-end mb-5 mx-4">Tentukan Prodi Lulus</button>
    </form>
