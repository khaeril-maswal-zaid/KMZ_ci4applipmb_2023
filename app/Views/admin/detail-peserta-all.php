...
<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h2">Database Daftar Ulang Mahasiswa Baru</h1>
        ...
        <div class="btn-toolbar mb-2 mb-md-0">
            ...
            <button class="btn btn-sm btn-danger me-2" id="tombol-pdf">Unduh PDF</button>
        </div>
    </div>

    <div id="trg-exp-pdf">

        <?php foreach ($detailPeserta as $detail) : ?>
                    ...
                    <div class="row">
                        ...
                        <div class="col-3">
                            <div class="overflow-hidden" style="max-width: 120.4px; max-height: 189px;">
                                <img src="https://lipmb.umbulukumba.ac.id/img/fotocamaba2022/<?= $detail['foto']; ?>" height="180">
                            </div>
                        </div>
                    </div>
