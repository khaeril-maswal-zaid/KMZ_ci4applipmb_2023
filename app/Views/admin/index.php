        ...
        <div class="col-md-4 offset-md-4 bg-white border border-warning rounded-3 my-md-5 shadow p-md-4 p-3">
            ...
            <form method="post" action="/admin/proseslogin">
                ...
                <div class="form-signin text-center">
                    ...
                    <h1 class="h3 fw-normal">Admin SIM-LIPMB</h1>

                    <p class="fw-normal fst-italic">Sistem Informasi manajemen <br> Lembaga Informasi Calon Mahasiswa Baru <br> Universitas Muhammadiyah Bulukumba</p>
            ...
            <span class="text-white">devaloper@lipmb.umbulukumba.ac.id&nbsp;&nbsp;&nbsp;||&nbsp;&nbsp;&nbsp;KMZ739165</span>
        </div>
    </div>
</div>
